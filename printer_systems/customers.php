            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    ...
                    <div class="col-12 col-xl-4">
                        <a class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1">Add Customer</a>
                    </div>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-danger" onclick="topdf()">Get PDF</a>
                        <div class="table-responsive">
                            <table class="table table-striped datatable" id="usertable">
                                ...
                                <tbody>
                                    <?php
                                    $db = new Database();
                                    $users = $db->query("SELECT * FROM users where u_type = 3 ")->fetchAll();
