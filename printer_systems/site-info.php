    ...
    <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Site Information</h3>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Welcome Note Information</h4>
                        ...
                        <table class="table table-striped datatable" id="usertable">
                                ...
                                <tbody>
                                    <?php
                                    $db = new Database();
                                    $users = $db->query("SELECT * FROM information ")->fetchAll();
                                    foreach($users as $res){
                                        ?>
                                    <tr>

                                        <td>
                                            <?php echo $res['info_title'] ?>
                                        </td>
                                        <td>
                                            <?php echo $res['info_type'] ?>
                                        </td>
                                        <td>
                                            <?php echo $res['info_description'] ?>
                                        </td>
                                        <td>
                                            <a class="btn text-primary" href="javascript: editUser(<?php echo $res['info_id'] ?>)"><i
                                                    class=" icon-check"></i></a>

                                            <a class="btn text-danger" href="javascript: deleteUser(<?php echo $res['info_id'] ?>)"><i
        ...
        <div>
            <h3 class="font-weight-bold">Add Site Information</h3>
            <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" id="addWelcomeInfo">
                            <div class="form-group">
                                <label for="service_title">Main Heading</label>
                                <input type="text" class="form-control" name="infoHeading">
                            </div>
                            <div class="form-group">
                                <label for="service_description">Information</label>
                                <textarea type="email" class="form-control" id="service_description" name="information"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="service_title">Information Type(Optional)</label>
                                <input type="text" class="form-control" name="infoType">
                            </div>
                        


                            <button type="submit" class="btn btn-primary mr-2">Add Information</button>
        ...
        $("#addWelcomeInfo").submit(function(e) {
            e.preventDefault();

            $.ajax({
                url: "../model/addSiteInfo.php",
                type: "POST",
                data: new FormData(this),
                contentType: false,
                cache: false,
