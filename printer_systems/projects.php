                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped datatable" id="usertable">
                                ...
                                <?php 
                                    $pr = $db->query("SELECT * FROM project p INNER JOIN users u ON p.student=u.u_id WHERE lecture =0")->fetchAll();
                                    foreach ($pr as $res) {
                                        ?>
                                    <tr>
                                        <td>
                                            <a href="project.php?project=<?php echo $res['pr_id'] ?>"><?php echo $res['pr_name'] ?></a>
                                        </td>
                                        <td>
